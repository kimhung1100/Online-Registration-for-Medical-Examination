                ...
                <div className={cx("input-form")}>
                    <div className={cx("type-form")}>
                        <div className={cx("style_form_group")}>
                            ...
                            <input id="label_name" type="text" className={cx("form-control")}
                                placeholder="Vui lòng nhập tên có dấu..."></input>
                        ...
                        <div className={cx("style_form_group")}>
                            ...
                            <input id="label_name" type="text" className={cx("form-control")}
                                placeholder="Vui lòng nhập tên tài khoản..."></input>
                            <span className={cx("style_input_warning")}></span>
                        </div>
                        <div className={cx("style_form_group")}>
                            <label for="label_name">
                            ...
                            <input id="label_name" type="password" className={cx("form-control")}

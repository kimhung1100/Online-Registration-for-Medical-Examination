...
import styles from './NhapLichKhamBacSi.module.scss';
import { UserContext } from '../../components/UserContext';
import whiteLogo from '../../assets/images/white_logo.jpg';
const cx = classNames.bind(styles);
function NhapLichKhamBacSi() {
                ...
                <div className={cx('style_content')}>
                    <div class="row justify-content-center form-group form-group-sm">
                        ...
                        <div class="col-3" style={{padding: '40px'}}>
                            <button type="button" class="btn btn-primary btn-lg" style={{backgroundColor: '#1da1f2', borderColor: '#1da1f2',fontSize: '1.5rem', width: '10rem' }}>Nhập file</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default NhapLichKhamBacSi;

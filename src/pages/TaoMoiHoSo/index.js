...
function TaoMoiHoSo() {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post(`http://localhost/Online-Registration-for-Medical-Examination/src/php/patients.php/patient/save`,sendData)
        .then((result)=>{
            ...
            <div className={cx("TaoMoiHoSo_form_chua_tung_kham", problem1&&"open", problem2&&"hide")}>
                ...
                <div className={cx("TaoMoiHoSo_button")}>
                    ...
                    {/* <a href="" className={cx("TaoMoiHoSo_agree")}> */}
                         <button type="submit"> <i className={cx("fa-solid fa-user-plus")}></i> Tạo mới</button>
                    {/* </a> */}
                    </div>

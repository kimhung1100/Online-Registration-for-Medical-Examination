...
export default function SuaHoSo (){
    ...
    const handleSubmit = async (e) => {
        ...
        axios.put(`http://localhost/Online-Registration-for-Medical-Examination-1/src/php/patients.php/patient/update`,sendData)
        .then((result)=>{
            console.log(data.id);
    ...
    return (
        ...
        <div className={cx("TaoMoiHoSo_wrapper")}>
            <div className={cx("TaoMoiHoSo_wrapper_content")}>
                <Link to="/" className={cx("TaoMoiHoSo_trang_chu")}>Trang chủ</Link> 
            ...
            <div className={cx("TaoMoiHoSo_form_chua_tung_kham", problem1&&"open", problem2&&"hide")}>
                ...
                <div className={cx("TaoMoiHoSo_dien_form")}>
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_ho_ten" )}
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_sdt")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <select name="gender" id="gender" aria-placeholder="Giới tính" value={data.gender} onChange={handleChange}>
                            <option value="">Chọn giới tính</option>
                            <option value="Nam" onChange={handleChange}>Nam</option>
                            <option value="Nữ" onChange={handleChange}>Nữ</option>
                        </select>
                    </div>
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        <label for=".job">
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_job")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_cmnd")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="email" className={cx("TaoMoiHoSo_email")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_ethnic")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_province")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_city")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_ward")} 
                    ...
                    <div className={cx("TaoMoiHoSo_form_box")}>
                        ...
                        <br></br>
                        <input type="text" className={cx("TaoMoiHoSo_address")} 
                ...
                <div className={cx("TaoMoiHoSo_button")}>
                    ...
                    {/* <a href="" className={cx("TaoMoiHoSo_agree")}> */}
                         <button type="submit"> <i className={cx("fa-solid fa-user-plus")}></i> Cập nhật </button>
                    {/* </a> */}
                    </div>

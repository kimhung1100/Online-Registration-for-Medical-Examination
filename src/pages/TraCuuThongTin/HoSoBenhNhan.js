...
export default function HoSoBenhNhan() {
    ...
    //const [obj, setObj]=useContext(user);
    useEffect(() => {
        const sendData = {
            userID: user.key,
        };
                        ...
                        {patient.length === 0 ? (
                            <div>
                                ...
                                <p className={cx('subMessageGuide')}>
                                    Vui lòng liên hệ bộ phận CSKH (19001080) nếu không tìm thấy hồ sơ bệnh nhân đã tạo
                                </p>
                                            ...
                                            <div data-test="card-body" className={cx('card-body', 'style_card_body')}>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <div className={cx('view_all')}>Xem thêm</div>
                                                    </li>
                                                    <li
                                                        data-test="list-group-item"
                                                        className={cx('list-group-item', 'list-group-item-undefined')}

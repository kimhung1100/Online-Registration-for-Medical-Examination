...
export default function HoSoBenhNhan() {
    ...
    return (
        <div id="RecordPatient">
            {chosenPatient ? (
                <ChiTietHoSo element={chosenPatient}></ChiTietHoSo>
            ) : (
                <div>
                                ...
                                {patient && patient.length === 0 ? (
                                    <div>
                                        ...
                                        <p className={cx('subMessageGuide')}>
                                            Vui lòng liên hệ bộ phận CSKH (19001080) nếu không tìm thấy hồ sơ bệnh nhân
                                            đã tạo
                                        </p>
                                    ...
                                    patient?.map((element, idx) => (
                                        <ul
                                            ...
                                            className={cx('list-group', 'list_group', 'list_group_parent')}
                                            key={idx}
                                        >
                                            <li
                                            ...
                                            >
                                                <div data-test="card" className={cx('card', 'style_card')}>
                                                    ...
                                                    >
                                                        <ul
                                                            data-test="list-group"
                                                            className={cx('list-group', 'list_group', 'sub_list_group')}
                                                        >
                                                            <li
                                                                data-test="list-group-item"
                                                                className={cx(
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    className={cx('view_all')}
                                                                    onClick={() => setChosenPatient(element)}
                                                                >
                                                                    Xem thêm
                                                                </div>
                                                            </li>
                                                            ...
                                                            >
                                                                <div className={cx('column1')}>
                                                                    <i class="far-regular fa-mobile-button"></i>Điện
                                                                    thoại
                                                                </div>
                                                                ...
                                                                <div className={cx('action_edit_remove')}>
                                                                    ...
                                                                    >
                                                                        <Link to={`/sua-ho-so/${element.id}`}>
                                                                            <i class="fal fa-edit"></i> Sửa hồ sơ{' '}
                                                                        </Link>
                                                                        <div
                                                                            data-test="waves"
                                                                            className={cx('Ripple ')}
